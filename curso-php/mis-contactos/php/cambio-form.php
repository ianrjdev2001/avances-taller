...
<div>
    ...
    <input type = "radio" id = "m" name = "sexo_rdo" title = "Tu sexo" 
    value = "M" <?php if($registro_contacto["sexo"] == "M"){echo "checked";}?> required/>
    &nbsp;<label for = "m">masculino</label>
    &nbsp;&nbsp;&nbsp;
    <input type = "radio" id = "f" name = "sexo_rdo" title = "Tu sexo" value = "F" 
...
<div>
    ...
    <input type = "number" id = "telefono" class = "cambio" name = "telefono_txt" placeholder = "Escribe tu telefono" title= "Tu telefono" 
    value = "<?php echo $registro_contacto["telefono"]?>"  required/>
</div>
<div>
...
<div>
    <label for = "foto">Foto: </label>
        <div class = ".adjuntar-archivo cambio">
            <input type = "file" id = "foto" class = "foto_fls" name = "foto_fls" title = "Sube tu foto"/>
